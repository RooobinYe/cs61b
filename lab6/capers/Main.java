    ...
    public static void main(String[] args) {
        ...
        switch (args[0]) {
            ...
            case "dog":
                ...
                CapersRepository.makeDog(dog.getName(), dog.getBreed(), dog.getAge());
                break;
            case "birthday":
                validateNumArgs("birthday", args, 2);
                Dog birthdayDog = new Dog(args[1], null, 0);
                CapersRepository.celebrateBirthday(birthdayDog.getName());
                break;
            default:
